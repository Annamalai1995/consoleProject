...
public class StudentBioData extends Studentdetails implements StudentdetailsFunctions,Runnable
{
    ...
    {
        studentinformartion[0]=new Studentdetails(101, "Annamalai", "Salem", 28, 9688193688l, 90.5f, 'M');
        studentinformartion[1]=new Studentdetails(102, "Gowthami", "Salem", 28, 9842687892l, 95.6f, 'F');
        studentinformartion[2]=new Studentdetails(103, "sathish", "chennai", 28, 9944567242l, 92.5f, 'M');
        studentinformartion[3]=new Studentdetails(104, "vidhya", "Palldam", 27, 9878546211l, 96.8f, 'F');
    }
    static
    {
        System.out.println(" Welcome to Holy cross \n");
    }
