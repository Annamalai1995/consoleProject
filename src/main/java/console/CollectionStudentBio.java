...
public class CollectionStudentBio extends Studentdetails implements Runnable,StudentdetailsFunctions {
    public CollectionStudentBio() {
        std.add(new Studentdetails(101, "Annamalai", "Salem", 28, 9688193688l, 90.5f, 'M'));
        std.add(new Studentdetails(102, "Gowthami", "Salem", 28, 9842687892l, 95.6f, 'F'));
        std.add(new Studentdetails(103, "sathish", "chennai", 28, 9944567242l, 92.5f, 'M'));
        std.add(new Studentdetails(104, "vidhya", "Palldam", 27, 9878546211l, 96.8f, 'F'));
    }
